    ...
    return (
        <div className='w-full bg-[#f2f2f2] py-10 '>
            <div className="container mx-auto">
                ...
                <img src={"/60.svg"} className={"mx-auto mb-20 block md:hidden"} alt="60+"/>
                <img src={"/60sm.svg"} className={"mx-auto mb-20 hidden md:block"} alt="60+"/>
                <div className='flex justify-evenly bg-gray-100 py-5 w-full overflow-y-auto gap-16'>
